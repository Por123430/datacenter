...
const TempStatistic = () => {
  ...
  const toggleBar = () => {
    setOptions(1);
    setBarButtonClicked(true); // Set the button clicked state to true
    setLineButtonClicked(false); // Reset the Line button clicked state
  };

  const toggleLine = () => {
    setOptions(2);
    setBarButtonClicked(false); // Reset the Bar button clicked state
    setLineButtonClicked(true); // Set the button clicked state to true
  };
